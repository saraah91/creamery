  ...
  private
    ...
    def admins_abilities
      unless current_users_role == "admin"
        respond_to do |format|
        format.html { redirect_to flavors_url, notice: 'You are not authorized to view this information/perform this action' }
        format.json { head :no_content }
        end
      end
    end
    ...
    def flavor_params
      params.require(:flavor).permit(:name, :string, :active, :boolean)
    end
end
