...
class StoreFlavorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create store_flavor" do
    assert_difference('StoreFlavor.count') do
      post store_flavors_url, params: { store_flavor: { flavor_id: @store_flavor.flavor_id, integer: @store_flavor.integer, store_id: @store_flavor.store_id } }
    end
  ...
  test "should update store_flavor" do
    patch store_flavor_url(@store_flavor), params: { store_flavor: { flavor_id: @store_flavor.flavor_id, integer: @store_flavor.integer, store_id: @store_flavor.store_id } }
