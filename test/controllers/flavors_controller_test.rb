...
class FlavorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flavor" do
    assert_difference('Flavor.count') do
      post flavors_url, params: { flavor: { active: @flavor.active, boolean: @flavor.boolean, name: @flavor.name, string: @flavor.string } }
    end
  ...
  test "should update flavor" do
    patch flavor_url(@flavor), params: { flavor: { active: @flavor.active, boolean: @flavor.boolean, name: @flavor.name, string: @flavor.string } }
